        ...
        {({ loading, error, data }) => {
          ...
          if (error) return <p>{error}</p>;
            ...
            if (data.playlist.songs.length > 0) {
              ...
              playlistArt = (<img src="https://www.andrewwkmusic.com/wp-content/uploads/2014/05/No-album-art-itunes.jpg" ></img>)
            }
                              ...
                              <div className="album-show-c3a-bottom">
                                ...
                                <Mutation mutation={DELETE_PLAYLIST}>
                                  {deletePlaylist => (
                                    <div
                                      id="context-menu"
                                      className={menuVisible ? "context-menu-show" : "context-menu-hidden"}
                                      onClick={() => {
                                        deletePlaylist({
                                          variables: {
