...
const keys = require("../../client/public/config/keys").secretOrKey;
...
const register = async data => {
  try {
    ...
    if (existingUser) {
      throw new Error("This user already exists. Please use a different email.");
    }
